...
Knn = pickle.load(open('Pkl Files/Knn.pkl', 'rb'))
Svm = pickle.load(open('Pkl Files/svm.pkl', 'rb'))
Naive = pickle.load(open('Pkl Files/Naive.pkl', 'rb'))
Decision = pickle.load(open('Pkl Files/decision_tree.pkl', 'rb'))
Gradient = pickle.load(open('Pkl Files\\GradientBoostingClassifier.pkl', 'rb'))
